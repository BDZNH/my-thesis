...
箭头 \includegraphics{jicheng.pdf} 由派生类指向基类。这些类与 FIRE engine 里面其他类的之间的关系见附录图 D.3 。
...
箭头 \includegraphics{jicheng.pdf} 由派生类指向基类。箭头 \includegraphics{chengyuan.pdf} 从一个类指向其成员变量的类型，箭头上方标注了该成员变量的名称。
